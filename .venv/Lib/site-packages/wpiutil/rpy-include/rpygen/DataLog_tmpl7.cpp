...
using BindType = rpygen::bind_wpi__log__DataLogValueEntryImpl<double>;
static std::unique_ptr<BindType> inst;

bind_wpi__log__DataLogValueEntryImpl_6::bind_wpi__log__DataLogValueEntryImpl_6(py::module &m, const char * clsName)
{
  inst = std::make_unique<BindType>(m, clsName);
}

void bind_wpi__log__DataLogValueEntryImpl_6::finish(const char *set_doc, const char *add_doc)
{
