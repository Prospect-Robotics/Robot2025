...
using BindType = rpygen::bind_wpi__log__DataLogValueEntryImpl<std::string>;
static std::unique_ptr<BindType> inst;

bind_wpi__log__DataLogValueEntryImpl_7::bind_wpi__log__DataLogValueEntryImpl_7(py::module &m, const char * clsName)
{
  inst = std::make_unique<BindType>(m, clsName);
}

void bind_wpi__log__DataLogValueEntryImpl_7::finish(const char *set_doc, const char *add_doc)
{
