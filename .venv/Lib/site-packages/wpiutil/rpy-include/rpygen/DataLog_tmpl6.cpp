...
using BindType = rpygen::bind_wpi__log__DataLogValueEntryImpl<float>;
static std::unique_ptr<BindType> inst;

bind_wpi__log__DataLogValueEntryImpl_5::bind_wpi__log__DataLogValueEntryImpl_5(py::module &m, const char * clsName)
{
  inst = std::make_unique<BindType>(m, clsName);
}

void bind_wpi__log__DataLogValueEntryImpl_5::finish(const char *set_doc, const char *add_doc)
{
