...
struct PyTrampoline_DataLog : PyTrampolineBase {
  ...
  #ifndef RPYGEN_DISABLE_Flush_v
    void Flush() override {
      using LookupBase = typename PyTrampolineCfg::Base;
      RPYBUILD_OVERRIDE_PURE_NAME(DataLog, PYBIND11_TYPE(void), LookupBase,
        "flush", Flush, );
    }
  #endif

  #ifndef RPYGEN_DISABLE_Pause_v
    void Pause() override {
      using LookupBase = typename PyTrampolineCfg::Base;
  ...
  #ifndef RPYGEN_DISABLE_Resume_v
  ...
  #ifndef RPYGEN_DISABLE_BufferHalfFull_v
  ...
  #ifndef RPYGEN_DISABLE_BufferFull_v
    bool BufferFull() override {
      using LookupBase = typename PyTrampolineCfg::Base;
      RPYBUILD_OVERRIDE_PURE_NAME(DataLog, PYBIND11_TYPE(bool), LookupBase,
        "_bufferFull", BufferFull, );
    }
  #endif

  #ifndef RPYBLD_DISABLE_StartFile_v
    #ifndef RPYBLD_UDISABLE_wpi__log__DataLog_StartFile
      using wpi::log::DataLog::StartFile;
      #define RPYBLD_UDISABLE_wpi__log__DataLog_StartFile
    #endif
  #endif
