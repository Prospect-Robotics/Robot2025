...
struct bind_frc__SwerveDrivePoseEstimator3d {
  py::class_<typename frc::SwerveDrivePoseEstimator3d<NumModules>, frc::PoseEstimator3d<wpi::array<SwerveModuleState, NumModules>, wpi::array<SwerveModulePosition, NumModules>>> cls_SwerveDrivePoseEstimator3d;
