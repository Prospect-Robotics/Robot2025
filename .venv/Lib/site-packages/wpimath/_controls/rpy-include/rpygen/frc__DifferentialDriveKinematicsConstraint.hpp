...
#include <frc\trajectory\constraint\DifferentialDriveKinematicsConstraint.h>
...
struct PyTrampolineCfg_DifferentialDriveKinematicsConstraint :
...
using PyTrampolineBase_DifferentialDriveKinematicsConstraint =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_DifferentialDriveKinematicsConstraint : PyTrampolineBase_DifferentialDriveKinematicsConstraint<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_DifferentialDriveKinematicsConstraint<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_DifferentialDriveKinematicsConstraint;
