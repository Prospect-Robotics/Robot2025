...
#include <frc\trajectory\constraint\CentripetalAccelerationConstraint.h>
...
struct PyTrampolineCfg_CentripetalAccelerationConstraint :
...
using PyTrampolineBase_CentripetalAccelerationConstraint =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_CentripetalAccelerationConstraint : PyTrampolineBase_CentripetalAccelerationConstraint<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_CentripetalAccelerationConstraint<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_CentripetalAccelerationConstraint;
