...
struct PyTrampolineCfg_DifferentialDriveVoltageConstraint :
...
using PyTrampolineBase_DifferentialDriveVoltageConstraint =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_DifferentialDriveVoltageConstraint : PyTrampolineBase_DifferentialDriveVoltageConstraint<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_DifferentialDriveVoltageConstraint<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_DifferentialDriveVoltageConstraint;
