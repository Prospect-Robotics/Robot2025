...
#include <frc\trajectory\constraint\MaxVelocityConstraint.h>
...
struct PyTrampolineCfg_MaxVelocityConstraint :
...
using PyTrampolineBase_MaxVelocityConstraint =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_MaxVelocityConstraint : PyTrampolineBase_MaxVelocityConstraint<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_MaxVelocityConstraint<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_MaxVelocityConstraint;
