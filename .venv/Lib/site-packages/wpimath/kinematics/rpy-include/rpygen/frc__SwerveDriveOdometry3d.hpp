...
struct bind_frc__SwerveDriveOdometry3d {
  py::class_<typename frc::SwerveDriveOdometry3d<NumModules>, frc::Odometry3d<wpi::array<SwerveModuleState, NumModules>, wpi::array<SwerveModulePosition, NumModules>>> cls_SwerveDriveOdometry3d;
