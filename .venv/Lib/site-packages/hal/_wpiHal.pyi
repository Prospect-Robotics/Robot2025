...
class tInstances:
    ...
    kDashboard_FRCWebComponents: typing.ClassVar[tInstances]  # value = <tInstances.kRobotDrive2_DifferentialCurvature: 9>
...
def checkRelayChannel(channel: int) -> int:
    ...
    :returns: true if the channel is valid, otherwise false
    """
def cleanAnalogTrigger(analogTriggerHandle: int) -> None:
    """
...
def cleanInterrupts(interruptHandle: int) -> None:
    ...
    """
def cleanNotifier(notifierHandle: int) -> None:
    """
    Cleans a notifier.
...
def closeSPI(port: SPIPort) -> None:
    ...
    """
def closeSerial(handle: int) -> None:
    """
...
def freeCTREPCM(handle: int) -> None:
    ...
    """
def freeCounter(counterHandle: int) -> None:
    """
    Frees a counter.
...
def freeDIOPort(dioPortHandle: int) -> None:
    ...
    """
def freeDigitalPWM(pwmGenerator: int) -> None:
    """
...
def freeDutyCycle(dutyCycleHandle: int) -> None:
    ...
    """
def freeEncoder(encoderHandle: int) -> None:
    """
    Frees an encoder.
    
    :param in: encoderHandle the encoder handle
    """
def freePWMPort(pwmPortHandle: int) -> None:
    """
    Frees a PWM port.
...
def getREVPHSolenoidCurrent(handle: int) -> tuple[float, int]:
    ...
    """
def getREVPHSolenoidDisabledList(handle: int) -> tuple[int, int]:
    """
    Get a bitmask of disabled solenoids.
