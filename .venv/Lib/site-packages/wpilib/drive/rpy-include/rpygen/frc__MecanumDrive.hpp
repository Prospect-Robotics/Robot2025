...
struct PyTrampolineCfg_MecanumDrive :
...
using PyTrampolineBase_MecanumDrive =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_MecanumDrive : PyTrampolineBase_MecanumDrive<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_MecanumDrive<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_MecanumDrive;
