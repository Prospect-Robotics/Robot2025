...
struct PyTrampolineCfg_REVPHSim :
...
using PyTrampolineBase_REVPHSim =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_REVPHSim : PyTrampolineBase_REVPHSim<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_REVPHSim<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_REVPHSim;
