...
struct PyTrampolineCfg_CTREPCMSim :
  frc::sim::PyTrampolineCfg_PneumaticsBaseSim<
  CfgBase
  >
{
...
using PyTrampolineBase_CTREPCMSim =
  frc::sim::PyTrampoline_PneumaticsBaseSim<
    PyTrampolineBase
    , PyTrampolineCfg>
;

template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_CTREPCMSim : PyTrampolineBase_CTREPCMSim<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_CTREPCMSim<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_CTREPCMSim;
