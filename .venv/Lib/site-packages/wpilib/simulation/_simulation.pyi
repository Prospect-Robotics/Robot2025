...
class DCMotorSim(LinearSystemSim_2_1_2):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_1_2, gearbox: wpimath._controls._controls.plant.DCMotor, measurementStdDevs: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(2)] = [0.0, 0.0]) -> None:
        """
...
class FlywheelSim(LinearSystemSim_1_1_1):
    ...
    def J(self) -> wpimath.units.kilogram_square_meters:
        ...
        Returns the moment of inertia
        """
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_1_1_1, gearbox: wpimath._controls._controls.plant.DCMotor, measurementStdDevs: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(1)] = [0.0]) -> None:
        """
...
class LinearSystemSim_1_1_1:
    ...
    def __init__(self, system: wpimath._controls._controls.system.LinearSystem_1_1_1, measurementStdDevs: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(1)] = [0.0]) -> None:
        ...
        """
    def _clampInput(self, maxInput: float) -> None:
        """
    ...
    def _updateX(self, currentXhat: numpy.ndarray[numpy.float64[1, 1]], u: numpy.ndarray[numpy.float64[1, 1]], dt: wpimath.units.seconds) -> numpy.ndarray[numpy.float64[1, 1]]:
        ...
        """
    @typing.overload
    def getInput(self) -> numpy.ndarray[numpy.float64[1, 1]]:
        """
        ...
        """
    @typing.overload
    def getInput(self, row: int) -> float:
        """
...
class LinearSystemSim_2_2_1:
    ...
    def _updateX(self, currentXhat: numpy.ndarray[numpy.float64[2, 1]], u: numpy.ndarray[numpy.float64[2, 1]], dt: wpimath.units.seconds) -> numpy.ndarray[numpy.float64[2, 1]]:
        ...
        """
    @typing.overload
    def getInput(self) -> numpy.ndarray[numpy.float64[2, 1]]:
        """
        Returns the current input of the plant.
...
class SingleJointedArmSim(LinearSystemSim_2_1_2):
    ...
    def estimateMOI(length: wpimath.units.meters, mass: wpimath.units.kilograms) -> wpimath.units.kilogram_square_meters:
        ...
        """
    @typing.overload
    def __init__(self, system: wpimath._controls._controls.system.LinearSystem_2_1_2, gearbox: wpimath._controls._controls.plant.DCMotor, gearing: float, armLength: wpimath.units.meters, minAngle: wpimath.units.radians, maxAngle: wpimath.units.radians, simulateGravity: bool, startingAngle: wpimath.units.radians, measurementStdDevs: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(2)] = [0.0, 0.0]) -> None:
        """
