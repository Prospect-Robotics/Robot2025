...
struct PyTrampolineCfg_Ultrasonic :
...
using PyTrampolineBase_Ultrasonic =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_Ultrasonic : PyTrampolineBase_Ultrasonic<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_Ultrasonic<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_Ultrasonic;
