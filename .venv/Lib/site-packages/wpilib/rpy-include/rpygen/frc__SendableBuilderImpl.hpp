...
struct PyTrampolineCfg_SendableBuilderImpl :
  nt::PyTrampolineCfg_NTSendableBuilder<
  CfgBase
  >
{
...
using PyTrampolineBase_SendableBuilderImpl =
  nt::PyTrampoline_NTSendableBuilder<
    PyTrampolineBase
    , PyTrampolineCfg>
;

template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_SendableBuilderImpl : PyTrampolineBase_SendableBuilderImpl<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_SendableBuilderImpl<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_SendableBuilderImpl;
