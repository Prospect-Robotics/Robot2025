...
struct PyTrampolineCfg_AnalogTriggerOutput :
...
using PyTrampolineBase_AnalogTriggerOutput =
...
template <typename PyTrampolineBase, typename PyTrampolineCfg>
struct PyTrampoline_AnalogTriggerOutput : PyTrampolineBase_AnalogTriggerOutput<PyTrampolineBase, PyTrampolineCfg> {
  using PyTrampolineBase_AnalogTriggerOutput<PyTrampolineBase, PyTrampolineCfg>::PyTrampolineBase_AnalogTriggerOutput;

  #ifdef RPYGEN_ENABLE_frc__AnalogTriggerOutput_PROTECTED_CONSTRUCTORS
    PyTrampoline_AnalogTriggerOutput(const AnalogTrigger& trigger, AnalogTriggerType outputType) :
      PyTrampolineBase_AnalogTriggerOutput<PyTrampolineBase, PyTrampolineCfg>(trigger, outputType)
    {}
  #endif
