...
public final class SysIdRoutineSelector {
  ...
  public Command getSelected() {
    ...
    if (routine == null || requestType == null || direction == null) {
      return Commands.print(
          String.format(
              "Some value was not selected! routine: %s, requestType: %s, direction: %s",
              routine, requestType, direction));
    }
  ...
  Command getCommand(
      SysIdRoutine routine, SysIdRequestType requestType, SysIdRoutine.Direction direction) {
